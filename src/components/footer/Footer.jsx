...
const Footer = () => {
    return (
      <>
<footer class="bg-[#0f0f0f] pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10 overflow-hidden px-5">
   <div class="container">
      <div class="flex flex-wrap -mx-4">
         <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               ...
               <p class="text-base text-body-color mb-7">
                For further details, newsletters , recommendations and other added benefits, subscribe to our paid service. We have the right to cancel the service in case we detect misuse and violation of our 
                <a href="/" className='text-pink-600'> terms and conditions</a>
               </p>
         ...
         <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               ...
               <p class="text-base text-body-color">&copy; 2025 Virtuoso | All rights reserved.</p>
            </div>
         </div>
      </div>
   </div>
