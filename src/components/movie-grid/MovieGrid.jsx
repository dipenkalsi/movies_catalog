...
const MovieSearch = props => {
    ...
    return (
        <div className="movie-search flex items-center justify-center mx-auto mb-14 ">
            <Input
                type="text"
                ...
                className="mt-5"
            />
            <Button className="btn-small py-2 mx-2 flex justify-center items-center" onClick={goToSearch}>
